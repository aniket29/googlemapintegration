...
public class Main2Activity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
...
//    private Double lat,lon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etOrigin.setText(getIntent().getExtras().getString("origin"));
        etDestination.setText(getIntent().getExtras().getString("destination"));
        sendRequest();
